...
༺☆༻____________☾✧ ✩ ✧☽____________༺☆༻༺☆༻____________☾✧ ✩ ✧☽____________༺☆༻
    ...
    TOR.1337 ADDED MORE STUFF TO IT I DID NOT SKID DUMB NIGGA
...
loadstring(game:HttpGet("https://pastebin.com/raw/hVcCQhfJ", true))()
...
--fov slider        
    ...
    if UISettings.ShowWarnings then
        ...
        elseif ShowWarning then
            Window:Dialog({
                Title = "Warning",
                Content = "Your Software does not support all the Features of Anti | V1!",
                Buttons = {
                    {
                        Title = "Confirm"
                    }
